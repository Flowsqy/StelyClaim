...
public class RemoveMemberSubCommand extends DomainSubCommand {
    ...
    public RemoveMemberSubCommand(@NotNull String name, @NotNull String[] triggers, @NotNull StelyClaimPlugin plugin, @Nullable Collection<String> worlds, @NotNull OtherCommandPermissionChecker data, @NotNull HelpMessage helpMessage) {
